...
<section class="hero  overflow-hidden relative max-lg:pt-150 pt-[240px] pb-[60px]">
  <div class="container">
    <div
      ...
      data-aos-once="true"
    >
      <p class="mb-4 font-medium uppercase">Contact Us</p>
      <h2 class="max-lg:mb-10 mb-10">Get in Touch with Us</h2>
      <p class="max-lg:mb-10 mb-12 max-w-[590px] mx-auto">We’re here to help! Whether you have a question about our services, need support, or want to discuss your next project, don’t hesitate to reach out.</p>
    </div>
  </div>
</section>
      ...
      <div class=" grid grid-cols-3 max-md:grid-cols-1 gap-8">
        ...
        >
          ...
          >
            ...
            <h3 class="mb-2.5">Development Office</h3>
            <p>Ofc # 676, Block A, Lahore Garden, Lahore, Pakistan</p>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <a href="mailto:hallo@aplio.com"> support@hisoftio.com </a>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-delay="600"data-aos-once="true">
          ...
          >
            ...
            <h3 class="mb-2.5">Phone or WhatsApp Number</h3>
            <a href="tel:+18254542642">+1 (825) 454 2642</a>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center" >
           <img src="/img/location.png"   width="40"
              ...
              fill="none"
              class="inline-block mb-6"/>
            <h3 class="mb-2.5">USA Office</h3>
            <a href="#"> 124 Remsen Road, Yonkers NewYork, USA.
            +1 (917) 880-1741  </a>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center" >
           <img src="/img/location.png"   width="40"
              ...
              fill="none"
              class="inline-block mb-6"/>
            <h3 class="mb-2.5">Canada Office</h3>
            <a href="#"> 129 Rainbow Falls Bay Chestermere, Calgary, Alberta, Canada.
            +1 (825) 454 2642  </a>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center" >
           <img src="/img/location.png"   width="40"
              ...
              fill="none"
              class="inline-block mb-6"/>
            <h3 class="mb-2.5">England Office</h3>
            <a href="#"> 24 Duarte Place Grays, Essex, England.
            +44 (794) 396-7957  </a>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center" >
           <img src="/img/location.png"   width="40"
              ...
              fill="none"
              class="inline-block mb-6"/>
            <h3 class="mb-2.5">Germany Office</h3>
            <a href="#"> Halle 2 – Raum 231, Herzbergstr. 128-139, 10365 Berlin, Germany.
            +49 (152) 5527-1872  </a>
          </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset="200" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 h-full max-lg:p-5 text-center" >
           <img src="/img/location.png"   width="40"
              ...
              fill="none"
              class="inline-block mb-6"/>
            <h3 class="mb-2.5">Pakistan Office</h3>
            <a href="#"> Ofc # 676, Block A, Lahore Garden, Near Faizpur Interchange, Lahore, Pakistan.
            +92 (304) 132-4141  </a>
          </div>
        </div>
